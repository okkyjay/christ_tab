...
// Customised George	
	...
	arguments.callee.add_token_api = function add_token (id, name) {
...
// Customised George
    ...
    function run_search(query) {
		//George
		var preId = "id_list=" + hidden_input.val().substring(0,hidden_input.val().length-1);
        ...
        if(cached_results) {
            ...
            if(settings.method == "POST") {
                ...
                $.get(settings.url + queryStringDelimiter + preId + '&' + settings.queryParam + "=" + encodeURIComponent(query), {}, callback, settings.contentType);
            }
        }
    }
};
