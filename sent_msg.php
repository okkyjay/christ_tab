...
if(isset($_POST['delSel']))
{
	...
	$resp = deleteSentMax($mid, $uid);
	$resp['title'] = 'Delete Sent Message';
...
$query_rec = "SELECT a.mid, a.uid as uid_int, a.date_sent, a.is_read, (SELECT concat(sname, ', ', fname) AS sender FROM mail_users WHERE id = b.uid) AS sender, b.uid, b.subject, b.body FROM (sent_msg AS a INNER JOIN messages AS b ON a.mid = b.id) WHERE a.uid = ".$_SESSION['uid_int']." ORDER BY date_sent DESC";
...
<div class="container span 10">
    ...
    <div class="span3">
      <div class="well sidebar-nav">
        <ul class="nav nav-list">
          ...
          <li class="active"><a href="sent_msg.php"><span class="icon-forward"></span>Sent</a></li>
  ...
  <div class="span9">
    ...
    <div class="row-fluid">
	  ...
	  if($totalRows_rec == 0)
	  {
		  echo "<em>There is no Message in your Sent Folder</em>";
	  }
	  else
	  {?>
          ...
          <table border="0" width="800px" height="132" class="table table-bordered">
            ...
            <?php do { ?>
              <tr>
                ...
                <td valign="middle"><a href="view_msg.php?mid=<?php echo md5($row_rec['mid']);?>&rid=<?php echo md5($row_rec['uid_int']);?>&folder=sent" style="<?php if($row_rec['is_read'] == 0)echo "font-weight:bold"; ?>"><?php echo $row_rec['subject']; ?></a></td>
                <td valign="middle"><?php echo $row_rec['date_sent']; ?></td>
              </tr>
