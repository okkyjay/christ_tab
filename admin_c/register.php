...
if(isset($_POST['submit_btn']))
{
	...
	if(checkData('admin_users', 'username', $username) > 0)
	{
      ...
      <form class="form-horizontal" id="appForm" name="appForm" autocomplete="off" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
            <table width="777" border="0" cellspacing="0" cellpadding="5">
              ...
              <tr>
                ...
                <td valign="middle">:</td>
                <td valign="middle"><select name="department" class="span3 required" id="department" placeholder="Department" title="Select Department">
                  <option value="">--</option>
                  <?php do{ ?>
              ...
              <tr>
                ...
                <td>:</td>
                <td><input name="secquest" type="text" class="span3 required" id="secquest" placeholder="Security question" title="Enter Personal Security Question" minlenght="6"></td>
              </tr>
              <tr>
                <td> Answer</td>
                <td>:</td>
