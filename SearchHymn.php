...
$filename = "SearchHymn.php"; // name of this file
$default = 40; // default number of records per page
$action = $_SERVER['PHP_SELF']; // if this doesn't work, enter the filename
$query = "SELECT * from hymns where title LIKE '%$my_s%'"; // database query. Enter your query here
}
else
{
$my_s=' ';
...
$action = $_SERVER['PHP_SELF']; // if this doesn't work, enter the filename
$query = "SELECT * from hymns "; // database query. Enter your query here
}
...
$myresult.="<td>
		   ...
		   <div ><a href='download.php?folder=hymns&file=$des' target='_blank'>Download</a></div>
</td>";
}
else
{
     ...
     <td width="509" align="left" valign="top"><table width="561" height="239" border="0" cellpadding="0" cellspacing="0">
       ...
       <tr>
         ...
         <td style="text-align:justify;" align="left" valign="top"><form name="form1" id="form1" method="post" action="" onsubmit="return validateform('form1');">
            <div align="center">
              <input name="searchval" type="text" id="searchval" style="height:25px; padding:5px 0px 5px 0px; border:1px solid #993300" size="40" placeholder="Search For Hymns by Name or Number" required/>
              &nbsp;&nbsp;&nbsp;
