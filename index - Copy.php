...
<title>ADComS&trade; ::: Login</title>
<!-- InstanceEndEditable -->
...
<style type="text/css">
body {
	background-image: url(img/ADC.jpg);
  ...
  <div class="navbar-inner">
    <div class="container-fluid">
      ...
      <!-- InstanceBeginEditable name="TopMenu" -->
      		<p class="navbar-text pull-left">Login</p>
      <!-- InstanceEndEditable -->
          ...
          <table width="98%" height="167" border="0" cellpadding="0" cellspacing="0">
    	    ...
    	    <tr>
    	      ...
    	      <td height="59">
                ...
                <p>&nbsp; </p>
                <p><a href="register.php"><span class="icon-pencil"></span>  Register Here</a></p></td>
   	        </tr>
  	    </table>
      </form>
    </div>
